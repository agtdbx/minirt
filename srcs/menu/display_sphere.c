...
/*   Updated: 2023/04/12 12:17:32 by aderouba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	display_sphere(t_all *all, t_sphere *sphere)
{
	...
	sphere->shininess_intensity -= 1.0f;
	manage_float(all, &sphere->shininess_intensity, 340, "shininess : ");
	sphere->shininess_intensity += 1.0f;
	...
	display_float(all, sphere->shininess_intensity, 340, "shininess : ");
