...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   sphere_transparency.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: aderouba <aderouba@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/02 09:04:52 by aderouba          #+#    #+#             */
/*   Updated: 2023/05/02 10:19:05 by aderouba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	calculate_out_ray(t_ray *refraction_ray, t_ray *transparency_ray,
				t_intersect_ret *refraction_res, t_sphere *sphere);
static void	intern_reflect(t_ray *refraction_ray,
				t_intersect_ret *refraction_res);
static void	sphere_reflect(t_ray *refraction_ray, t_ray *transparency_ray,
				t_intersect_ret *refraction_res, t_sphere *sphere);
...
static void	calculate_out_ray(t_ray *refraction_ray, t_ray *transparency_ray,
				t_intersect_ret *refraction_res, t_sphere *sphere)
{
	float const	ni_over_nt = sphere->refraction_intensity;
	...
	if (refract(&refraction_ray->direction, &refraction_res->nrm, ni_over_nt,
		...
		sphere_reflect(refraction_ray, transparency_ray, refraction_res,
			sphere);
}
